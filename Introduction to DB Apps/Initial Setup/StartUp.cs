        ...
        static void Main(string[] args)
        {
            ...
            using (connection)
            {
                try
                {
                    ...
                    Console.WriteLine("Datebase created seccessfully!");
                }
                catch (Exception e)
                {
                    Console.WriteLine("Databese cannot be created !");
            ...
            using (connection)
            {
                ...
                SqlCommand createTable = new SqlCommand(queryText, connection);
                ...
                try
                {
                    ...
                    Console.WriteLine("Data inserted seccessfully");
                    Console.WriteLine($"{rowsAffected} rows affected!");
                }
                catch (Exception e)
                {
                    Console.WriteLine("There was error processing your requesst!");
                    Console.WriteLine(e.Message);
                }
            }
        }
