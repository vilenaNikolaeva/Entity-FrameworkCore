        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HomeTeamBatRate = table.Column<int>(type: "int", nullable: false),
                    AwayTeamBetRate = table.Column<int>(type: "int", nullable: false),
                    DrawBetRate = table.Column<int>(type: "int", nullable: false),
                    Result = table.Column<int>(type: "int", maxLength: 7, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SquadNumber = table.Column<int>(type: "int", unicode: false, maxLength: 3, nullable: false),
                    TeamId = table.Column<int>(type: "int", nullable: false),
                    PositionId = table.Column<int>(type: "int", nullable: false),
